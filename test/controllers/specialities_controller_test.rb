...
class SpecialitiesControllerTest < ActionController::TestCase
  ...
  test "should create speciality" do
    assert_difference('Speciality.count') do
      post :create, speciality: { academic_degree_id: @speciality.academic_degree_id, descripcion: @speciality.descripcion }
    end
  ...
  test "should update speciality" do
    patch :update, id: @speciality, speciality: { academic_degree_id: @speciality.academic_degree_id, descripcion: @speciality.descripcion }
    assert_redirected_to speciality_path(assigns(:speciality))
  end
