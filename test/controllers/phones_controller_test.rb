...
class PhonesControllerTest < ActionController::TestCase
  ...
  test "should create phone" do
    assert_difference('Phone.count') do
      post :create, phone: { numero: @phone.numero, postgraduate_coordination_id: @phone.postgraduate_coordination_id }
    end
  ...
  test "should update phone" do
    patch :update, id: @phone, phone: { numero: @phone.numero, postgraduate_coordination_id: @phone.postgraduate_coordination_id }
    assert_redirected_to phone_path(assigns(:phone))
  end
