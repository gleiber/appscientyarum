...
class ObjectivesControllerTest < ActionController::TestCase
  ...
  test "should create objective" do
    assert_difference('Objective.count') do
      post :create, objective: { descripcion: @objective.descripcion, postgraduate_coordination_id: @objective.postgraduate_coordination_id }
    end
  ...
  test "should update objective" do
    patch :update, id: @objective, objective: { descripcion: @objective.descripcion, postgraduate_coordination_id: @objective.postgraduate_coordination_id }
    assert_redirected_to objective_path(assigns(:objective))
  end
