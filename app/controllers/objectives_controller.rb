class ObjectivesController < ApplicationController
  ...
  def create
    ...
    @objective.postgraduate_coordination_id = 1
    respond_to do |format|
      if @objective.save
        format.html { redirect_to '/objetivos' , notice:"Objectivo creado exitosamente." }
  ...
  private
    ...
    def objective_params
      params.require(:objective).permit(:descripcion, :postgraduate_coordination_id)
    end
end
