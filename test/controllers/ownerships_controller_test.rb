...
class OwnershipsControllerTest < ActionController::TestCase
  ...
  test "should create ownership" do
    assert_difference('Ownership.count') do
      post :create, ownership: { academic_degree_id: @ownership.academic_degree_id, postulate_id: @ownership.postulate_id, user_id: @ownership.user_id }
    end
  ...
  test "should update ownership" do
    patch :update, id: @ownership, ownership: { academic_degree_id: @ownership.academic_degree_id, postulate_id: @ownership.postulate_id, user_id: @ownership.user_id }
    assert_redirected_to ownership_path(assigns(:ownership))
  end
