...
ActiveRecord::Schema.define(version: 20170313144843) do
  ...
  create_table "cities", force: :cascade do |t|
    ...
    t.datetime "created_at",  null: false
    t.datetime "updated_at",  null: false
    t.index ["estados_id"], name: "index_cities_on_estados_id", using: :btree
  end
  ...
  create_table "defending_theses", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["result_id"], name: "index_defending_theses_on_result_id", using: :btree
  end
  ...
  create_table "sub_per_users", force: :cascade do |t|
    t.string   "nota"
    t.integer  "user_id"
    t.integer  "coh_per_sub_us_id"
    t.datetime "created_at",        null: false
    t.datetime "updated_at",        null: false
    t.index ["coh_per_sub_us_id"], name: "index_sub_per_users_on_coh_per_sub_us_id", using: :btree
  ...
  create_table "subjects", force: :cascade do |t|
    ...
    t.integer  "type_subjects_id"
    t.datetime "created_at",       null: false
    t.datetime "updated_at",       null: false
    t.integer  "type_subject_id"
    t.index ["type_subject_id"], name: "index_subjects_on_type_subject_id", using: :btree
    t.index ["type_subjects_id"], name: "index_subjects_on_type_subjects_id", using: :btree
  end
  ...
  add_foreign_key "cities", "estados", column: "estados_id"
  ...
  add_foreign_key "defending_theses", "results"
  ...
  add_foreign_key "sub_per_users", "coh_per_sub_us", column: "coh_per_sub_us_id"
  ...
  add_foreign_key "subjects", "type_subjects", column: "type_subjects_id"
