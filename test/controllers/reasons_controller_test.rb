...
class ReasonsControllerTest < ActionController::TestCase
  ...
  test "should create reason" do
    assert_difference('Reason.count') do
      post :create, reason: { descipcion: @reason.descipcion, request_classroom_laboratory_id: @reason.request_classroom_laboratory_id, type_reason_id: @reason.type_reason_id }
    end
  ...
  test "should update reason" do
    patch :update, id: @reason, reason: { descipcion: @reason.descipcion, request_classroom_laboratory_id: @reason.request_classroom_laboratory_id, type_reason_id: @reason.type_reason_id }
    assert_redirected_to reason_path(assigns(:reason))
  end
