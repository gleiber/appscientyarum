...
class DetailsControllerTest < ActionController::TestCase
  ...
  test "should create detail" do
    assert_difference('Detail.count') do
      post :create, detail: { descripcion: @detail.descripcion, postulate_id: @detail.postulate_id, program_id: @detail.program_id }
    end
  ...
  test "should update detail" do
    patch :update, id: @detail, detail: { descripcion: @detail.descripcion, postulate_id: @detail.postulate_id, program_id: @detail.program_id }
    assert_redirected_to detail_path(assigns(:detail))
  end
