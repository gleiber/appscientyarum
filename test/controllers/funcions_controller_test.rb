...
class FuncionsControllerTest < ActionController::TestCase
  ...
  test "should create funcion" do
    assert_difference('Funcion.count') do
      post :create, funcion: { descripcion: @funcion.descripcion, estatus: @funcion.estatus, id_funcion: @funcion.id_funcion, id_padre: @funcion.id_padre, url: @funcion.url }
    end
  ...
  test "should update funcion" do
    patch :update, id: @funcion, funcion: { descripcion: @funcion.descripcion, estatus: @funcion.estatus, id_funcion: @funcion.id_funcion, id_padre: @funcion.id_padre, url: @funcion.url }
    assert_redirected_to funcion_path(assigns(:funcion))
  end
